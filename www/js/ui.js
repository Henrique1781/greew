...
(function (global) {
  ...
  var ICONS = {
    ...
    news: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"><path d="M4 5.5A1.5 1.5 0 015.5 4h10A1.5 1.5 0 0117 5.5V18a2 2 0 002 2H6a2 2 0 01-2-2z"/><path d="M20 20a2 2 0 002-2V9h-5" stroke-linecap="round"/><path d="M7.5 8h6M7.5 11.5h6M7.5 15h4" stroke-linecap="round"/></svg>',
    externo: '<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 5h5v5M19 5l-8 8M17 14v5H5V7h5"/></svg>',
